...
import { IoAdd, IoCheckmark, IoClose, IoEye, IoFolder, IoSaveOutline, IoSettings, IoShareSocial, IoTrash, IoTrashOutline } from "react-icons/io5";
import {
  MdArrowDropDown,
  MdArrowDropUp,
  MdEmail,
...
import styles from "./deep-search.module.css";
  ...
  paginatedData.map((item) => (
    ...
    <div className={styles.resultHeader}>
      ...
      {item.pages && item.pages.length > 0 ? (
        <div>
          <p className={styles.matchedPagesLabel}>
            Matched Pages:
          </p>
        ...
        <p className={styles.noHighlights}>
